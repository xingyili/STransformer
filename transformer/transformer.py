...
class Transformer(nn.Module):
    ...
    def get_enc_dec_attention_map(self) -> torch.Tensor:
        """Get the encoder-decoder attention map from the last decoding layer."""
        return self.layers_decoding[-1].enc_dec_attention_map
